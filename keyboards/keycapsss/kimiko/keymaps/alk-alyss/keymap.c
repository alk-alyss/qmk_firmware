 ...
 * `--------------------------------------------|        /   \        |----------------------------------------------'
 *                 | DELETE| LALT | LCTRL| LOWER|  BSP  /     \ Space | RAISE| RCTRL| ENTER| RALT |
 *                 `-----------------------------------'       '----------------------------------'
 */
...
[_BASE] = LAYOUT(
    ...
    ESC_GUI,    KC_A,    KC_S,    KC_D,    KC_F,    KC_G,                      KC_H,    KC_J,    KC_K,    KC_L, KC_SCLN, KC_QUOT,
    KC_LSFT,    KC_Z,    KC_X,    KC_C,    KC_V,    KC_B, KC_MPLY, KC_MUTE,    KC_N,    KC_M, KC_COMM,  KC_DOT, KC_SLSH, KC_RSFT,
                       KC_DEL, KC_LALT, KC_LCTL,   LOWER, KC_BSPC,  KC_SPC,   RAISE,  KC_RCTL, KC_ENT, KC_RALT
),
...
[_LOWER] = LAYOUT(
    ...
    ESC_GUI, KC_EXLM,   KC_AT, KC_HASH,  KC_DLR, KC_PERC,                   XXXXXXX,    KC_4,    KC_5,    KC_6, KC_LCBR, KC_RCBR,
 ...
 * |         |      |      |      |      |      |                     |      |      |      |      |      | GAME_LAYER|
 * |---------+------+------+------+------+------|                     |------+------+------+------+------+-----------|
 * |         |  F12 |  F7  |  F8  |  F9  | PSCR |                     | REDO | COPY | PASTE|  CUT | UNDO |           |
 * |---------+------+------+------+------+------|                     |------+------+------+------+------+-----------|
 * | GUI/ESC |  F11 |  F4  |  F5  |  F6  | SCLK |--------.   ,--------| LEFT | DOWN |  UP  |RIGHT |      |           |
 * |---------+------+------+------+------+------|  Play  |   |  Mute  |------+------+------+------+------+-----------|
 * |  LSFT   |  F10 |  F1  |  F2  |  F3  | PSBR |--------|   |--------| CAPS | HOME | PGUP | PGDN |  END |  RSFT     |
 * `--------------------------------------------|        /   \        |----------------------------------------------'
 *                 | DELETE| LALT | LCTRL| LOWER|  BSP  /     \ Space | RAISE| RCTRL| ENTER| RALT |
 *                 `-----------------------------------'       '----------------------------------'
 */
...
[_RAISE] = LAYOUT(
    XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,                   XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,  GAMING,
     KC_TAB,  KC_F12,   KC_F7,   KC_F8,   KC_F9, KC_PSCR,                   KC_AGIN, KC_COPY, KC_PSTE,  KC_CUT, KC_UNDO, XXXXXXX,
    ESC_GUI,  KC_F11,   KC_F4,   KC_F5,   KC_F6, KC_SCRL,                   KC_LEFT, KC_DOWN,   KC_UP, KC_RGHT, XXXXXXX, XXXXXXX,
    KC_LSFT,  KC_F10,   KC_F1,   KC_F2,   KC_F3,  KC_BRK, _______, _______, KC_CAPS, KC_HOME, KC_PGUP, KC_PGDN,  KC_END, KC_RSFT,
 ...
 * `-----------------------------------------/       /     \      \----------------------------------------------'
 *               |     |       | LALT |Space|   B   /      \      \ LEFT |  UP  | DOWN | RIGHT|      |
 *               `----------------------------------'       '----------------------------------------'
 */
